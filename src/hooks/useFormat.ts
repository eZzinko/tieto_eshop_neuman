...
export const useFormat = () => {
	 ...
	 * @return {string}
	 */
	const formatNumber = (value: number, settings?: Intl.NumberFormatOptions, locale?: string) =>
	 ...
	 * @return {string}
	 */
	const formatPrice = (value: number, settings?: Intl.NumberFormatOptions, locale?: string) =>
